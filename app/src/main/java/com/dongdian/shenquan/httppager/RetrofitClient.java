...
public class RetrofitClient {
    ...
    //服务端根路径
    //   public static String baseUrl = "http://open.biyingniao.com";
    public static String baseUrl = "https://test.wef2.top";
...
//                .cache(cache)
        ...
        builder .addInterceptor(new LoggingInterceptor
                ...
                .addHeader("app-key", Contants.APPKEY)
                .addHeader("v", com.dongdian.shenquan.utils.Utils.getVersionName(mContext))//系统版本号
                .addHeader("device", "android")//设备信息
                .addHeader("app-type", "android")//设备信息
