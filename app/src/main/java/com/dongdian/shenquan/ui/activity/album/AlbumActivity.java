...
public class AlbumActivity extends MyBaseActivity<ActivityAlbumBinding,AlbumViewModel> {
    ...
    public void initData() {
        ...
        viewModel.id.set(targType+"");
        initProduct();
    }
    //列表初始化
    private void initProduct() {

        Utils.initListView(this, binding.albumRecycler, new DividerDecoration(Color.parseColor("#dddddd"), 0), adapter, new PullListener() {
            @Override
            ...
            public void onLoadMore() {
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        binding.albumRecycler.setRefreshing(false);
                        if (page == 1) {
                            return;
                        }
                        viewModel.getList(page);
        ...
        binding.albumTitleZongheLayou.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                binding.albumTitleZonghe.setTextColor(0xffFFD409);
                binding.albumTitleXiaoliangTitle.setTextColor(0xff666666);
                binding.albumTitleJiageTitle.setTextColor(0xff666666);
                binding.albumTitleXiaoliangShang.setImageResource(R.mipmap.ic_shang_iss);
                binding.albumTitleXiaoliangXia.setImageResource(R.mipmap.ic_xia_iss);
                binding.albumTitleJiageShang.setImageResource(R.mipmap.ic_shang_iss);
                binding.albumTitleJiageXia.setImageResource(R.mipmap.ic_xia_iss);
                page=1;
                sort="";
                xialiang=0;
                jiage=0;
        ...
        binding.albumTitleXiaoliangLayou.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                binding.albumTitleZonghe.setTextColor(0xff666666);
                binding.albumTitleXiaoliangTitle.setTextColor(0xffFFD409);
                binding.albumTitleJiageTitle.setTextColor(0xff666666);
                if(xialiang==0||xialiang==2){
                    binding.albumTitleXiaoliangShang.setImageResource(R.mipmap.ic_shang_iss);
                    binding.albumTitleXiaoliangXia.setImageResource(R.mipmap.ic_xia_s);
                    sort="month_sales_des";
                    xialiang=1;
                }else{
                    binding.albumTitleXiaoliangShang.setImageResource(R.mipmap.ic_shang_s);
                    binding.albumTitleXiaoliangXia.setImageResource(R.mipmap.ic_xia_iss);
        ...
        binding.albumTitleJiageLayou.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                binding.albumTitleZonghe.setTextColor(0xff666666);
                binding.albumTitleXiaoliangTitle.setTextColor(0xff666666);
                binding.albumTitleJiageTitle.setTextColor(0xffFFD409);
                if(jiage==0||jiage==2){
                    binding.albumTitleJiageShang.setImageResource(R.mipmap.ic_shang_iss);
                    binding.albumTitleJiageXia.setImageResource(R.mipmap.ic_xia_s);
                    sort="discount_price_des";
                    jiage=1;
                }else{
                    binding.albumTitleJiageShang.setImageResource(R.mipmap.ic_shang_s);
                    binding.albumTitleJiageXia.setImageResource(R.mipmap.ic_xia_iss);
